  ...
  return (
    <div className="punxy__modal">
      <div className="punxy__modal__wrap">
        <Masthead>
          <h1>seeding disperses your current transactions out to all your peers. likewise, your local store will be replenished with your peers' seeds. fight the power.</h1>
        </Masthead>
